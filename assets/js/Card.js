...
const cardPresets = [
        ...
        new Card("Doctor Goodman", 5, 15, "DEFENSE PHASE: HoT effect for 10 HP over 2 rounds", "defense", "hot", 10, 2, "A highly intelligent and famous doctor who revolutionized the modern steampunk world.", "doctor", 7),
        new Card("Nest Protector", 40, 5, "No special skill", "none", "none", 0, 0, "A proud avian warrior who was sent out to protect his land from evil.", "eagle-warrior", 5),
        ...
        new Card("Mercenary", 40, 10, "No special skill", "none", "none", 0, 0, "A mercenary, here for one reason: Combat.", "mercenary", 5),
