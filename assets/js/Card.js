...
const cardPresets = [
        ...
        new Card("Doctor Goodman", 5, 40, "ATTACK MODE: Healing over time effect for 10 HP", "attack", "hot", 10, 3, "Description", "doctor", 30),
        new Card("Talonus", 40, 5, "Special Description", "defense", "Special Type", "Special Value", 3, "Description", "eagle-warrior", 1),
        new Card("Shamus", 3, 20, `ATTACK MODE: DoT effect for 15 damage`, "attack", "dot", 15, 3, "Description", "forest-shaman", 40),
        new Card("Ingrid", 10, 65, "Special Description", "none", "Special Type", "Special Value", 3, "Description", "forest-spirit", 1),
        new Card("Magus", 35, 15, "Special Description", "none", "Special Type", "Special Value", 3, "Description", "mage", 1),
        new Card("Rambo", 25, 10, "Special Description", "attack", "Special Type", "Special Value", 3, "Description", "mercenary", 1),
