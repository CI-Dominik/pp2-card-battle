...
const cardPresets = [
        ...
        new Card("Nest Protector", 40, 5, "No special skill", "none", "none", 0, 0, "A proud avian warrior who was sent out to protect his land from evil.", "eagle-warrior", 7),
        new Card("Woodland Shaman", 5, 30, "ATTACK PHASE: DoT effect for 8 damage over 5 rounds", "attack", "dot", 15, 5, "Coming from the lands of the unknown, the Woodland Shaman inflicts curses to his enemies.", "forest-shaman", 4),
        new Card("Irydil", 5, 40, "No special skill", "none", "none", 0, 0, "A forest spirit sent by the nature gods to cleanse the woods of threats.", "forest-spirit", 5),
        new Card("Magna", 35, 10, "No special skill", "none", "none", 0, 0, "An arcane sorceress who gains her power from ancient spirits of the earth.", "mage", 6),
        new Card("Mercenary", 40, 10, "No special skill", "none", "none", 0, 0, "A mercenary, here for one reason: Combat.", "mercenary", 6),
